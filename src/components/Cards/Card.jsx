...
function Card({ image, title, description, route }) {
    return (
        <div className="bg-darkWhite mx-auto pt-20 pb-8 px-0 md:px-8 md:pt-2 rounded-md relative max-w-sm w-full h-2/3">
            <div className="absolute -top-14 left-1/2 transform -translate-x-1/2 w-38 h-36 md:w-38 md:h-38 justify-center imageShadow">
